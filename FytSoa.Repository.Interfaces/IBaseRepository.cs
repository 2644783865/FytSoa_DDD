...
namespace FytSoa.Repository.Interfaces
{
    /// <summary>
    /// 定义基本服务
    /// </summary>
    ...
    public interface IBaseRepository<T>  where T : class
    {
		...
		/// <returns></returns>
		Task<Page<T>> GetPagesAsync(int pageIndex, int pageSize, bool Async = true);
        ...
        /// <param name="Async">是否同步</param>
        /// <returns></returns>
        Task<Page<T>> GetPagesAsync(Expression<Func<T, bool>> where,
