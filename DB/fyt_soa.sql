...
CREATE TABLE `sys_admin`  (
  `Id` bigint(25) NOT NULL COMMENT '唯一编号',
  ...
  `OrganizeId` bigint(25) NOT NULL COMMENT '所属部门',
...
CREATE TABLE `sys_authority`  (
  `RoleId` bigint(25) NOT NULL COMMENT '角色编号',
  `AdminId` bigint(25) NULL DEFAULT NULL COMMENT '管理员编号',
  `MenuId` bigint(25) NULL DEFAULT NULL COMMENT '菜单编号',
...
CREATE TABLE `sys_code`  (
  `Id` bigint(25) NOT NULL COMMENT '唯一编号',
  `TypeGuid` bigint(25) NOT NULL COMMENT '分类编号',
...
CREATE TABLE `sys_menu`  (
  ...
  `ParentId` bigint(25) NULL DEFAULT NULL COMMENT '父节点',
...
CREATE TABLE `sys_organize`  (
  `Id` bigint(25) NOT NULL COMMENT '唯一编号',
  `ParentId` bigint(25) NOT NULL COMMENT '父节点',
...
CREATE TABLE `sys_role`  (
  ...
  `ParentId` bigint(25) NULL DEFAULT NULL COMMENT '角色父节点',
  `Layer` int(11) NOT NULL DEFAULT 1 COMMENT '角色层级',
  `Number` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '角色编号',
