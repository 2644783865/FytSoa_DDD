...
namespace FytSoa.Application.Sys
{
    public class SysMenuService : ISysMenuService
    {
        ...
        /// <returns></returns>
        public async Task<ApiResult<Page<SysMenu>>> PageList(PageParam param)
        {
            var result = new ApiResult<Page<SysMenu>>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<ApiResult<string>> Add(SysMenu model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public async Task<ApiResult<string>> Modify(SysMenu model)
        {
            var result = new ApiResult<string>();
            try
            {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public async Task<ApiResult<SysMenu>> GetModel(long id)
        {
