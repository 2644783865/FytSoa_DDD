...
namespace FytSoa.Common
{
    ...
    public class FileHelper
    {
        ...
        /// </summary>
        /// <param name="sourcePath">源文件</param>
        /// <param name="destFileName">目标文件夹</param>
        public static bool Rename(string sourcePath,string destFileName)
        {
            //判断源文件是否存在
            if (!File.Exists(MapPath(sourcePath))) return false;
            File.Move(MapPath(sourcePath), MapPath(destFileName));
            return true;
        }
